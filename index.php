...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
                    ...
                    <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            <div class="container">
                                ...
                                <h2>You Will Shatter, This Belief of Impossibility</h2>
                                <h3 class="gap">Join Us &amp; Prove The World</h3>
                    ...
                    <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                        <div class="sl-slide-inner">
                            <div class="container">
                                ...
                                <h2>Looking For a Better Job?</h2>
                                <h3 class="gap">We Serve The Better</h3>
                                <a class="btn btn-large btn-transparent" href="#">Learn More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            <div class="container">
                                ...
                                <h3 class="gap">A Change For Success Occurs</h3>
                                <a class="btn btn-large btn-transparent" href="#">Learn More</a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="about-us" class="container main">
        ...
        <div class="row-fluid">
            <div class="span8">
                ...
                <div class="blog">
				    <div class="blog page-header">
					    <h1 class="text-uppercase">Latest Opportunities</h1>
					</div>
					...
					<!--Opportunity 1-->
						...
						<div class="span9">
                        <a href="#"><h3>Opportunity1 Duis sed odio sit amet nibh vulputate cursus</h3></a>
				...
				<div class="blog">
				    ...
				    <div class="blog page-header">
					    <h1 class="text-uppercase">Latest Jobs</h1>
					</div>
					
					<!--Job1-->
                    <div class="blog-item well">
                        <a href="#"><h2>Job1 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Job. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a>
                    </div>
					
                    <!--Job2-->
                    <div class="blog-item well">
                        <a href="#"><h2>Job2 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a>
                    </div>
					...
					<!--Job3-->
                    <div class="blog-item well">
                        <a href="#"><h2>Job3 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Job. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a><br />
						<a class="btn btn-lg btn-primary" href="#">More Jobs</a>
                    </div>
				...
				<div class="blog">
					...
					<!--News 1-->
                    <div class="blog-item well">
                        <a href="#"><h2>News1 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a>
                    </div>
                    ...
                    <!--News 2-->
                    <div class="blog-item well">
                        <a href="#"><h2>News2 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a>
                    </div>
					...
					<!--News 3-->
                    <div class="blog-item well">
                        <a href="#"><h2>News3 Duis sed odio sit amet nibh vulputate cursus</h2></a>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
                        <a class="btn btn-link" href="#">Read More <i class="icon-angle-right"></i></a><br />
						<a class="btn btn-lg btn-primary" href="#">More News</a>
                    </div>
              <!-- End Blog Item -->
			...
			<!--End Latest Opportunity,Jobs,News-->
